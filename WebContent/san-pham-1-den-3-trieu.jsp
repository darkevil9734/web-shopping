          ...
          <div class="row">
            ...
            <div class="col-md-9">
              ...
              <div class="products-grid">
                ...
                <div class="row">
                	<c:forEach items="${dssp_1Den3Trieu}" var="ds_1Den3Trieu">
		               <form action="themGioHang?id=${ds_1Den3Trieu.ma_san_pham}" method="post">
		                  <div class="col-md-4 col-sm-6">
		                    	<div class="products">
	                                <div class="offer">Trả Góp 0%</div>
	                                <div class="thumbnail"><a href="xemChiTietSanPhamServlet?id=${ds_1Den3Trieu.ma_san_pham}"><img src="Views/productIMG/${ds_1Den3Trieu.hinh_dai_dien}" alt="Product Name"></a></div>
	                                <div class="productname">${ds_1Den3Trieu.tenSanPham}</div>
	                                <h4 class="price"><f:formatNumber type="number" value="${ds_1Den3Trieu.giaSanPham}"/> ₫</h4>
