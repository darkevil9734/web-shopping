          ...
          <div class="row">
            ...
            <div class="col-md-9">
              ...
              <div class="products-grid">
                ...
                <div class="row">
                	<c:forEach items="${dssp_nhucau}" var="dssp_nhucau">
		               <form action="themGioHang?id=${dssp_nhucau.ma_san_pham}" method="post">
		                  <div class="col-md-4 col-sm-6">
		                    	<div class="products">
	                                <div class="offer">Trả Góp 0%</div>
	                                <div class="thumbnail"><a href="xemChiTietSanPhamServlet?id=${dssp_nhucau.ma_san_pham}"><img src="Views/productIMG/${dssp_nhucau.hinh_dai_dien}" alt="Product Name"></a></div>
	                                <div class="productname">${dssp_nhucau.tenSanPham}</div>
	                                <h4 class="price"><f:formatNumber type="number" value="${dssp_nhucau.giaSanPham}"/> ₫</h4>
