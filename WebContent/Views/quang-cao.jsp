               ...
               <div id="sequence">
                  ...
                  <ul class="sequence-canvas">
                     <li class="animate-in" style="display: list-item; z-index: 3;">
                        <div class="flat-caption caption1 formLeft delay300 text-center" style=""><span class="suphead">Apple Iphone X</span></div>
                        <div class="flat-caption caption2 formLeft delay400 text-center" style="">
                           <h1>Siêu Phẩm 2017</h1>
                        </div>
                     ...
                     <li style="display: list-item; z-index: 1;" class="animate-out">
                        <div class="flat-caption caption2 formLeft delay400" style="">
               ...
               <div class="container">
                  <div class="row">
                     <div class="col-md-4 col-sm-4 col-xs-4">
                        <div class="promo-box"><img src="images/promotion-01.jpg" alt=""></div>
                     </div>
                     <div class="col-md-4 col-sm-4 col-xs-4">
                        <div class="promo-box"><img src="images/promotion-02.jpg" alt=""></div>
                     </div>
                     <div class="col-md-4 col-sm-4 col-xs-4">
                        <div class="promo-box"><img src="images/promotion-03.jpg" alt=""></div>
                     </div>
                  </div>
               </div>
            </div>
