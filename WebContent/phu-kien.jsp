          ...
          <div class="row">
            ...
            <div class="col-md-9">
              ...
              <div class="products-grid">
                ...
                <div class="row">
                	<c:forEach items="${dspk }" var="ds_phukien">
	                  <form action="themGioHang?id=${ds_phukien.ma_san_pham}" method="post">
		                  <div class="col-md-4 col-sm-6">
		                    	<div class="products">
	                                <div class="offer">Trả Góp 0%</div>
	                                <div class="thumbnail"><a href="xemChiTietSanPhamServlet?id=${ds_phukien.ma_san_pham}"><img src="Views/productIMG/${ds_phukien.hinh_dai_dien}" alt="Product Name"></a></div>
	                                <div class="productname">${ds_phukien.tenSanPham}</div>
	                                <h4 class="price"><f:formatNumber type="number" value="${ds_phukien.giaSanPham}" /> ₫</h4>
