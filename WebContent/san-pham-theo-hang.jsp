	                  ...
	                  <form action="themGioHang?id=${dsh.ma_san_pham}" method="post">
		                  <div class="col-md-4 col-sm-6">
		                    	<div class="products">
	                                ...
	                                <div class="thumbnail"><a href="xemChiTietSanPhamServlet?id=${dsh.ma_san_pham}"><img src="Views/productIMG/${dsh.hinh_dai_dien}" alt="Product Name"></a></div>
	                                <div class="productname">${dsh.tenSanPham}</div>
	                                <h4 class="price"><f:formatNumber type="number" value="${dsh.giaSanPham}" /> ₫</h4>
